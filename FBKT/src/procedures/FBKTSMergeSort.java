...
public class FBKTSMergeSort extends RSP {
	...
	public FBKTSMergeSort(int N, int N0, ArrayList<Double> mu, ArrayList<Double> sigma2,boolean PCSAllocation) {
		this.N = N;
		this.N0 = N0;
		this.mu.addAll(mu);
